...
/**
 * Dynamic Gateway API that can use different base URLs for different chains.
 * This is a wrapper around the standard GatewayApi that allows chain-specific gateways.
 */
interface DynamicGatewayApi {
